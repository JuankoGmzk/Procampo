...
<body>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
					...
					<div class="bio mb-3"> musmusmusmusmusmus musmusmusmusmus....<br></div><!--//bio-->
    ...
    $coment = "SELECT * FROM proyectos WHERE code = 'F101'"  ;
			...
			<div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
						    ...
						    <div class="meta mb-1"><span class="date"><?php echo $con['code']; ?></span><span class="time">5 min read</span><span class="comment"><a href="#">8 comments</a></span></div>
